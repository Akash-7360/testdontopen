...
import { format, isSameDay, isPast, isToday as isTodayFn, addDays } from 'date-fns';
import { Plus, Check, Calendar, Bell, BookOpen, Tag, Edit, Trash } from 'lucide-react';
...
const DeadlinesPage: React.FC = () => {
  ...
  // Ensure isToday is declared and used correctly
  const isToday = (date: Date) => isSameDay(date, new Date());

  // Update isPastDate logic
          ...
          <div className="divide-y divide-slate-200 dark:divide-slate-700">
            {Object.keys(groupedDeadlines)
              ...
              .map(dateStr => {
                ...
                const isPastDateGroup = isPastDate(date);
                ...
                return (
                  <div key={dateStr} className="p-4">
                    <div className="mb-4 flex items-center">
                      ...
                      >
                        {isPastDateGroup ? 'Past Due' : isTodayGroup ? 'Today' : 'Upcoming'}
                      </span>
                    </div>
